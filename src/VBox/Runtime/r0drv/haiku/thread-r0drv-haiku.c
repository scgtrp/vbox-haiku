/* $Id: thread-r0drv-haiku.cpp 28800 2010-04-27 08:22:32Z vboxsync $ */
/** @file
...
{
    Assert(hThread == NIL_RTTHREAD);
	/** @toto Haiku: check if Thread::next_priority or
...
RTDECL(bool) RTThreadIsInInterrupt(RTTHREAD hThread)
{
    ...
    /** @todo Haiku: Implement RTThreadIsInInterrupt. Required for guest
     *        additions! */
