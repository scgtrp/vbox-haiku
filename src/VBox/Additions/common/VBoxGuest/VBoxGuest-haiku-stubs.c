...
void RTSpinlockAcquireNoInts(RTSPINLOCK Spinlock, PRTSPINLOCKTMP pTmp) {
    g_VBoxGuest->_RTSpinlockAcquireNoInts(Spinlock, pTmp);
}
void RTSpinlockReleaseNoInts(RTSPINLOCK Spinlock, PRTSPINLOCKTMP pTmp) {
    g_VBoxGuest->_RTSpinlockReleaseNoInts(Spinlock, pTmp);
}
